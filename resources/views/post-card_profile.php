...
<div class="card mb-5">
         ...
         <a href="post-card_details.php?postid=<?php echo $row_post['postid']; ?>" class="text-decoration-none link-dark">
            ...
            <img src="<?php echo $row_post['photo']; ?>" class="card-img-top border border-1 border-dark" alt="Image Content">
            <?php endif; ?>
            </a>
            <div class="d-flex justify-content-between mt-2 align-items-center">
                ...
                <div class="col-lg-6">
                  ...
                  <?php if($like==false) : ?>
                       <a href="like_prof.php?userid=<?php echo $_SESSION['myblog_userid']; ?>&postid=<?php echo $row_post['postid']; ?>"
                         class="btn btn-outline-danger" id="like-button">
                         <i class="fa fa-heart"></i>
                       </a>
                       <?php else : ?>
