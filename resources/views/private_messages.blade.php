...
@section('content')
    ...
    <input type="text" id="friendSearch" class="form-control mb-3" placeholder="Знайти користувача...">
...
$('#friendSearch').on('input', function() {
    ...
    $.ajax({
        ...
        success: function(data) {
            // Replace the content of the friends list with the search results
            $('.list-group').empty().append(data);
        },
        error: function(error) {
